<template>
  ...
  <h1 class="text-4xl font-bold tracking-tight text-slate-800 dark:text-slate-100 sm:text-5xl">Welcome to FinalSay</h1>
  <p class="mx-auto mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-400">Democracy's answer to 'because I said so.' Create two‑sided questions with fully custom labels and discover what the community thinks.</p>
    <div class="mt-16">
